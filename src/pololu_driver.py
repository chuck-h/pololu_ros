...
class Pololu:
    """Represents a single Pololu Simple Motor Controller in standard config""""
...
class Daisy(Pololu):
	...
	Here is an example of usage
        ::
            p0 = Daisy(0) # initialize a Pololu daisy chained with device number 0
            p1 = Daisy(1) # initialize a Pololu daisy chained with device number 1
